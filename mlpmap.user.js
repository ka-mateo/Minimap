...
function updateloop(){
  ...
  var url_fr = "http://mlpixel.org/force_refresh.php";
...
function loadImage(imagename){
  ...
  if(cachebreaker != null)
    image_list[imagename].src = "http://mlpixel.org/image.php?name=" + imagename + "&cachebreaker=" + cachebreaker;
  else
    image_list[imagename].src = "http://mlpixel.org/image.php?name=" + imagename;
